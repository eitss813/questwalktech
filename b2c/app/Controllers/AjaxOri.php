...
class Ajax extends BaseController
{
  ...
  public function addGameToCart($gameid=NULL)
  {
    if(!empty($gameid) && !empty($this->userId))
    {
      ...
      {
        die(json_encode(array('class' => 'bg-success', 'title' => '', 'subtitle' => 'Success', 'icon' => 'fas fa-check-circle', 'delay' => 2500, 'type' => 'success', 'code' => 200, 'image' => '', 'imageAlt' => '', 'message' => 'Game successfully added to cart.', 'devMsg' => 'No msg', 'data' => $dbResult, 'redirect' => '')));
      }
    }
    else
    {
